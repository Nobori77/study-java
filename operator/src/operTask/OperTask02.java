...
//      고라니를 좋아하는 당신은 미쳤습니다.
	   ...
	   String message = "고양이, 소, 강아지, 고라니 중 운명의 동물을 찾아보세요",
			   cat = "고양이",
			   catResult = "고양이를 좋아하는 당신은 대훈이의 러버입니다.",
			   cow = "소",
			   cowResult = "소를 좋아하는 당신은 세종이의 단짝입니다.",
			   dog = "강아지",
			   dogResult = "강아지를 좋아하는 당신은 민균이의 짝사랑입니다.",
			   deer = "고라니",
			   deerResult = "고라니를 좋아하는 당신은 미쳤습니다.",
			   textResult = "",
			   animalResult = null;
	   
	   			System.out.println(message);
	   
	   			animalResult = sc.next();
	   		   
	   			textResult = cat.equals(animalResult) ? catResult
	   				   : cow.equals(animalResult) ? cowResult 
	   						   : dog.equals(animalResult) ? dogResult
	   								   : deer.equals(animalResult) ? deerResult : "잘못 입력하셨습니다.";
