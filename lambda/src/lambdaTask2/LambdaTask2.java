...
//      "abcabc"
	   ...
	   GetOverNumber getOverNumber = (str, num) ->{
		 String result = "";
	   ...
	   System.out.println(getOverNumber.over("안녕하세요 반갑습니다", 4));
...
//      "c"
	   ...
	   GetReturnResult getRetrunResult = (str, c) -> {
		   int count = 0;
	   ...
	   System.out.println(getRetrunResult.returnResult("asdaqsd", 'a'));
...
//      "가나다라마바사"
//      .contains("") boolean
	   GetRemoveString getRemoveString = (input) -> {
		   String result = "";
	   ...
	   System.out.println(getRemoveString.remove("abbbasdas"));
...
//      "987654321"
	   ...
	   GetReverseString getReverseString = (str) -> {
		 String result = "";
		 for(int i = 0; i < str.length(); i++) {
	   ...
	   System.out.println(getReverseString.reverse("adddddd"));
